...
def save_file():
    ...
    if file is None:
        ...
        try:
            ...
            print("Sorry!!! Couldn't save file!")
...
window = Tk()
window.title("Text editor Program.1.0")
file = None
...
file_menu = Menu(menu_bar, tearoff=0) # without tearoff there will be a strange line
menu_bar.add_cascade(label="File", menu=file_menu)

file_menu.add_command(label="New", command=new_file)
file_menu.add_command(label="Open", command=open_file)
file_menu.add_command(label="Save", command=save_file)
file_menu.add_separator() # separates Save and Exit labels in menu
